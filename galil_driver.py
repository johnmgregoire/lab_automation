...
class galil():
    ...
    def digital_out_on(self, port: int):
        ...
        return {'port': port, 'value': self.read_digital_out(port), 'type': 'digital_out'}
    ...
    def infinite_digital_cycles(self,on_time=0.2, off_time=0.2, port=0,init_time=0):
        ...
        while self.cycle_lights:
            ...
            time.sleep(off_time)
        return {'port': port, 'value': 'ran_infinite_light_cycles', 'type': 'digital_out'}

    def break_infinite_digital_cycles(self,on_time=0.2, off_time=0.2, port=0,init_time=0):
        self.cycle_lights = False
